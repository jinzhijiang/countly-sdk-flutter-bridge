...
void main() {
  ...
  testWidgets('SBS_200D_test', (WidgetTester tester) async {
    ...
    expect(EQ.length, 0);
    print(requestArray);
    validateRequestCounts({'events': 0, 'location': 1, 'crash': 0, 'begin_session': 0, 'consent': 0, 'end_session': 0, 'session_duration': 0, 'apm': 2, 'user_details': Platform.isIOS ? 2 : 1}, requestArray);
    validateInternalEventCounts({}, requestArray);
