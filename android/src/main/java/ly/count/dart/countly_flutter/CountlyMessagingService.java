...
//        }
        ...
        Log.d(TAG, "Message: id: " + message.id() + " msg: " + message.message() + " title: " + message.title());
        Log.d(TAG, "is this null: " + getApplicationContext().getSystemService(Context.NOTIFICATION_SERVICE));
